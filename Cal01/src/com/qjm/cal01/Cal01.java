...
public class Cal01 extends Activity implements OnClickListener{
	...
	public void onClick(View v){
		...
		case R.id.button04:{S="";edittext01.setText(S);break;}
		...
		case R.id.button19:{S=S.substring(0,S.length()-1);edittext01.setText(S);break;}
